    ...
    <div className="page">
      <header className="page-header">
        ...
        <div className="invoice-detail-inline-actions">
          ...
          <button type="button" className="button button-secondary" onClick={() => navigate(`/purchases/orders/${document.id}/edit`)}>Edit</button>
