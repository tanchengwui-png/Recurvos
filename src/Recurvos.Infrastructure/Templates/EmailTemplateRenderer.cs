...
public static class EmailTemplateRenderer
{
    ...
    public static string RenderReceiptEmail(
        string issuerName,
        string customerName,
        string invoiceNumber,
        ...
        string paidAtLabel)
    {
        var encodedTitle = Encode($"Receipt {receiptNumber}");
        var encodedIssuerName = Encode(issuerName);
        var encodedCustomerName = Encode(customerName);
        var encodedInvoiceNumber = Encode(invoiceNumber);
        var encodedReceiptNumber = Encode(receiptNumber);
        var encodedAmountPaid = Encode(amountPaid);
        var encodedPaidAt = Encode(paidAtLabel);
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background:#eef2f7;padding:20px 16px;">
            <tr>
              <td align="center">
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:640px;background:#ffffff;border-radius:24px;overflow:hidden;border:1px solid #dbe4f0;box-shadow:0 18px 40px rgba(15,23,42,0.08);">
                  <tr>
                    <td style="padding:22px 28px;background:#14532d;background-image:linear-gradient(135deg,#14532d,#16a34a);color:#ffffff;">
                      <div style="font-size:12px;letter-spacing:0.16em;text-transform:uppercase;opacity:0.88;font-weight:700;color:#ffffff;">Payment receipt</div>
                      <div style="font-size:28px;line-height:1.15;font-weight:700;margin-top:8px;color:#ffffff;">{{encodedTitle}}</div>
                      <p style="margin:12px 0 0;font-size:14px;line-height:1.7;color:#dcfce7;">From {{encodedIssuerName}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:24px 28px 28px;">
                      <p style="margin:0 0 16px;font-size:16px;line-height:1.7;color:#334155;">Hi {{encodedCustomerName}}, payment has been received for invoice {{encodedInvoiceNumber}}. Your receipt is attached.</p>
                      <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 20px;border:1px solid #e2e8f0;border-radius:18px;background:#f8fafc;">
                        <tr>
                          <td style="padding:20px 22px;">
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td style="padding:0 0 12px;font-size:12px;letter-spacing:0.14em;text-transform:uppercase;color:#94a3b8;font-weight:700;">Receipt</td>
                                <td align="right" style="padding:0 0 12px;font-size:16px;font-weight:700;color:#0f172a;">{{encodedReceiptNumber}}</td>
                              </tr>
                              <tr>
                                <td style="padding:0 0 12px;font-size:12px;letter-spacing:0.14em;text-transform:uppercase;color:#94a3b8;font-weight:700;">Invoice</td>
                                <td align="right" style="padding:0 0 12px;font-size:16px;font-weight:700;color:#0f172a;">{{encodedInvoiceNumber}}</td>
                              ...
                              <tr>
                                <td style="padding:0 0 12px;font-size:12px;letter-spacing:0.14em;text-transform:uppercase;color:#94a3b8;font-weight:700;">Amount paid</td>
                                <td align="right" style="padding:0 0 12px;font-size:16px;font-weight:700;color:#0f172a;">{{encodedAmountPaid}}</td>
                              </tr>
                              <tr>
                                <td style="padding:0;font-size:12px;letter-spacing:0.14em;text-transform:uppercase;color:#94a3b8;font-weight:700;">Paid on</td>
                                <td align="right" style="padding:0;font-size:15px;color:#334155;">{{encodedPaidAt}}</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                      </table>
                      <div style="padding:18px 20px;border-radius:18px;background:#f0fdf4;border:1px solid #bbf7d0;">
                        <p style="margin:0;font-size:14px;line-height:1.7;color:#166534;">Keep this email for your records. The attached PDF is the system-generated receipt for this payment.</p>
                      </div>
                    </td>
                  </tr>
                  <tr>
